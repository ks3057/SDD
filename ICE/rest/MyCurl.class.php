...
//get remote file using curl
    public static function getRemoteFile($url, $accept="")
    {
    ...
    public static function getRemoteFile2($url)
    {
    ...
    public static function sendCookies($url, $cookieFile, $cookies="")
    {
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, $url);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    ...
    public static function sendPostWithCookies($url, $data, $cookieFile, $cookies)
    {
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, $url);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    ...
    public static function sendPut($url, $data)
    {
        //$data = array("a" => $a);
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, $url);
    ...
    public static function sendDelete($url, $data)
    {
