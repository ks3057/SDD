...
class DB
{
    ...
    public function getPeopleFirstName($name)
    {
        try {
    ...
    public function getPeopleParameterized($id)
    {
        try {
            $data = array();
    ...
    public function getPeopleParameterizedAlt($id)
    {
        try {
            $data = array();
            $stmt = $this->dbh->prepare("SELECT * FROM people WHERE PersonID = :id");
    ...
    public function getPeopleParameterizedAlt2($id)
    {
        try {
            $data = array();
            $stmt = $this->dbh->prepare("SELECT * FROM people WHERE PersonID = :id");
    ...
    public function insert($last, $first, $nick)
    {
        try {
